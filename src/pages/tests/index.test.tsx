...
describe("index page", () => {
  ...
  it("should render list, previous button should be disabled", () => {
    ...
    expect(screen.getByRole('heading', { name: "Allergies Quiz" })).toBeInTheDocument();
    expect(screen.getByText('Does your dog get ear infections?')).toBeInTheDocument();
  ...
  it('should skip questions that satifies skipConditions', () => {
    ...
    expect(screen.getByText('Does your dog get red, sore or bald patches?')).toBeInTheDocument();
  });

  it('at the end of the test should redirect to a report page', () => {
    render(<IndexPage {...props} />);
